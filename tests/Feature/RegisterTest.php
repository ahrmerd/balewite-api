...
class RegisterTest extends TestCase
{
    ...
    protected $payload = ['username' => 'ahmed', 'email' => 'ahrmerd@gmail.com', 'department_id' => '1', 'phone_number' => '0903230603', 'password' => 'masmam', 'phone' => '09012345678'];
    ...
    {
        $payload = $this->payload;
        $payload['phone'] = '2349030685318';
        $this->post('/api/register', $payload)->assertStatus(201);
        $this->assertEquals('2349030685318', auth()->user()->phone_number);
    }
